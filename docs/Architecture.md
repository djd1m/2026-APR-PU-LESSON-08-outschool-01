...
| **Поиск** | Elasticsearch | 8.x | Полнотекстовый поиск с морфологией русского языка, фасетный поиск, автодополнение, агрегации. SLA: < 500ms для полнотекстового поиска, < 200ms для фильтрации |
