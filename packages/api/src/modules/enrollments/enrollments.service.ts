...
export class EnrollmentsService {
  ...
  /**
   * Cancel enrollment. Only the parent who owns the child can cancel.
   * Refund is created if the enrollment was paid.
   */
  async cancel(parentId: string, enrollmentId: string) {
